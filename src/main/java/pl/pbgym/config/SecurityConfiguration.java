    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests((auth) -> auth
                        ...
                        .hasAnyAuthority("ADMIN", "USER_MANAGEMENT", "MEMBER")
                        .requestMatchers("/members/changePassword/")
                        .hasAnyAuthority("ADMIN", "USER_MANAGEMENT", "MEMBER")
                        .requestMatchers("/trainers/")
                        .hasAnyAuthority("ADMIN", "USER_MANAGEMENT", "TRAINER")
                        .requestMatchers("/trainers/changePassword/")
                        .hasAnyAuthority("ADMIN", "USER_MANAGEMENT", "TRAINER")
                        .requestMatchers("/workers/")
                        .hasAnyAuthority("ADMIN", "WORKER")
                        .requestMatchers("/workers/changePassword/")
                        .hasAnyAuthority("ADMIN", "WORKER")
